...
static const struct option long_options[] = {
        ...
        // 热参数，启动后可修改 
        {"image_path",      required_argument, NULL, 'i'}, // 初始图片路径 
...
const char *optionalMsg = "--models: models directory.\n" \
                          ...
                          "--keys: keys file name.\n" \
                          "--image_path: If filled, use this path for a single OCR.If left blank, enter OCR work loop.\n"\
                          ...
                          "--GPU: Disable(-1)/GPU0(0)/GPU1(1)/... Use CUDA GPU accelerate, default: GPU0(0)\n\n";

const char *otherMsg = "--version: show version\n" \
                       "--help: print this help\n\n";

const char *example1Msg = "Example1: %s --image_path=\"D:/images/test(1).png\"\n\n";
